...
Page({
    ...
    onLoad: function(a) {
        ...
        this.setData({
            ...
            success: function(a) {
                ...
                /ios/i.test(a.system) && this.setData({
                    iosyo: 1
                });
            }
        });
    ...
    Shenhelist: function() {
        ...
        app.util.request({
            ...
            success: function(a) {
                ...
                console.log(a.data);
                for (var s = 0; s < e.length; s++) e[s] = e[s].reverse();
                o.setData({
                    liswet: e,
                    reua: t,
                    liu_id: i
    ...
    onShareAppMessage: function(a) {
        ...
        return "button" === a.from && console.log(a.target), {
            title: this.data.config.treesharetitle,
            imageUrl: this.data.config.treesharepic,
            path: "hc_pdd/component/pages/redbag/redbag?outuser_id=" + app.globalData.user_id + "&hb_id=" + this.data.hb_id
        };
    }
});